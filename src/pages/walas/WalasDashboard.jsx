      ...
      <section>
        ...
        <div className="space-y-2 md:hidden">
          {students.length ? students.slice(0, 8).map((student) => (
            <div key={student.id} className="rounded-2xl border border-white/80 bg-white p-4 shadow-soft">
              <div className="flex items-start justify-between gap-3">
                <div className="min-w-0">
                  <p className="truncate text-base font-bold text-slate-950">{student.name}</p>
