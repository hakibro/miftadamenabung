		...
		<Routes>
			...
			<Route element={<ProtectedRoute roles={["admin"]} />}>
				<Route element={<AppLayout />}>
					...
					<Route
						...
						element={<Navigate to="/walas/savings-withdrawals" replace />}
					/>
			...
			<Route element={<ProtectedRoute roles={["walas"]} />}>
				<Route element={<AppLayout />}>
					...
					<Route
						path="/walas/charges"
						element={<Navigate to="/walas/input" replace />}
					/>
					<Route
						path="/walas/savings-withdrawals"
						element={<SavingsWithdrawalsPage scope="walas" />}
					/>
